...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <table class="nav-justified">
        ...
        <tr>
            <td style="width: 349px">Confirmar clave</td>
            <td>
                <asp:TextBox ID="txtClaveConfirmar" runat="server" TextMode="Password" Width="167px"></asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="width: 349px">&nbsp;</td>
            <td>
                <asp:Button ID="btnCancelar" runat="server" OnClick="btnCancelar_Click" Text="Regresar" />
