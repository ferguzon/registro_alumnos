        ...
        <asp:View ID="vwBuscarUsuario" runat="server">
         ...
         <asp:View ID="vwActualizarUsuario" runat="server">
             <table class="nav-justified">
                 ...
                 <tr>
                     <td style="width: 498px">Nombre de usuario</td>
                     <td>
                 ...
                 <tr>
                     ...
                     <td>
                         ...
                         &nbsp;<asp:Button ID="btnEliminarUsuario" runat="server" OnClick="btnEliminarUsuario_Click" Text="Eliminar" />
                     </td>
                 </tr>
             </table>
        </asp:View>
